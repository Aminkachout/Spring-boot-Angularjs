...
public class JWTAuthorizationFilter  extends OncePerRequestFilter{
	...
	protected void doFilterInternal(
		...
		String jwt= request.getHeader(SecurityConstants.HEADRE_STRING);
		if(request.getMethod().equals("OPTIONS"))
		{
			...
			UsernamePasswordAuthenticationToken authenticatednuer= new UsernamePasswordAuthenticationToken(username, null,authorities);
			SecurityContextHolder.getContext().setAuthentication(authenticatednuer);
			filterChain.doFilter(request, response);
		}
